...
Versión sin confirmación - se ejecuta directamente
"""
import os
import sys
...
async def main():
    ...
    print("=" * 70)
    print("Regenerando embeddings automáticamente (sin confirmación)")
    print("=" * 70)
    ...
    # Obtener TODOS los reportes con fotos
    ...
    try:
        ...
        print(f"⏱️  Tiempo estimado: ~{len(reports) * 2} segundos")
        print()
